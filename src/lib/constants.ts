...
export const EXPERIENCES = [
  {
    ...
    stack: "NestJS · Next.js · PostgreSQL · DevOps · RPA",
    description: {
      pt: [
        "Criação de marketplace para agronegócio (Agroplayer)",
        "Sistema de automação WhatsApp (Zap Suite — milhares de usuários)",
        "Arquitetura, infra e automação de deploys",
      ],
      en: [
        "Creation of agribusiness marketplace (Agroplayer)",
        "WhatsApp automation system (Zap Suite — thousands of users)",
        "Architecture, infrastructure, and deployment automation",
      ],
    },
    links: [
  ...
  },
  {
    ...
    stack: "React · NestJS · Node · AWS · CI/CD · Material-UI",
    description: {
      pt: [
        "Produto Aceleres AI (plataforma de mercado)",
        "AWS: VPC, Lambda, S3, EC2, RDS, Amplify",
        "Liderança técnica, gestão de sprints no Jira",
      ],
      en: [
        "Aceleres AI product (market platform)",
        "AWS: VPC, Lambda, S3, EC2, RDS, Amplify",
        "Technical leadership, sprint management in Jira",
      ],
    },
  },
  {
  ...
  },
  {
    ...
    stack: "React · Node.js · Firebase · GCP · Figma",
    description: {
      pt: [
        "Startup early-stage — produto inovador",
        "Colaboração com devs seniores",
      ],
      en: [
        "Early-stage startup — innovative product",
...
export const SKILLS = {
  frontend: [
    ...
    { name: "Vue.js", level: "Advanced", progress: 70 },
    { name: "Nuxt.js", level: "Advanced", progress: 70 },
    { name: "TypeScript", level: "Expert", progress: 90 },
    { name: "CSS/SASS", level: "Expert", progress: 95 },
    { name: "Tailwind", level: "Expert", progress: 90 },
    { name: "React Native", level: "Intermediate", progress: 65 },
    { name: "Expo", level: "Intermediate", progress: 65 },
